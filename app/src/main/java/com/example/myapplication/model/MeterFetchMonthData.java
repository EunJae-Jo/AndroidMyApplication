...
public class MeterFetchMonthData {
    public BigDecimal thisMonthKwh;
    public BigDecimal totalCost;

    public Map<String, MeterFetchData> data;

    public MeterFetchMonthData(JsonArray obj){
        data = new HashMap<>();
        ...
        thisMonthKwh = tempJson.get("thisMonthKwh").getAsBigDecimal();
