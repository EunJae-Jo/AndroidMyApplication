...
public class NoticeListAdapter extends BaseAdapter {
    ...
    public NoticeListAdapter(Context context, ArrayList<NoticeORM> list_itemArrayList) {
    ...
    public View getView(int i, View convertView, ViewGroup viewGroup) {
        if(convertView == null){
            convertView = LayoutInflater.from(context).inflate(R.layout.setting_notice_item,null);
