...
public class ProgressivePaginator {
    ...
    public ProgressivePaginator(ArrayList<ProgressiveORM> itemArrayList) {
    ...
    public ArrayList<ProgressiveORM> getCurrent(int currentPage){
        int startItem = currentPage * ITEMS_PER_PAGES;
        int lastItem = startItem + ITEMS_PER_PAGES;

        ArrayList<ProgressiveORM> current = new ArrayList<ProgressiveORM>();
